...
# openmpi:
FPPFLAGS += $(shell pkg-config --cflags ompi-fort ompi-c)
#FPPFLAGS += $(shell pkg-config --cflags mpich)
...
CPPFLAGS += $(shell pkg-config --cflags ompi-c) $(shell pkg-config --cflags ompi-fort)
#CPPFLAGS += $(shell pkg-config --cflags mpich)
...
# MPI library flags
LIBS += $(shell pkg-config --libs ompi-c ompi-fort)
#LIBS += $(shell pkg-config --libs ompi-c) $(pkg-config --libs ompi-fort)
...
LDFLAGS += $(LIBS)
#
# add LDFLAGS from shell or compiler script. Not sure (yet) what happens if
#  the variable does not exist.
LDFLAGS += $(LIBS_FROM_SHELL)
